...
| --- | --- | --- | --- |
| 001 | [Truthful graph and usable camera](001-truthful-graph-and-camera/spec.md) | In progress: US1 shipped in 0.3.0 · [tasks](001-truthful-graph-and-camera/tasks.md) | — |
